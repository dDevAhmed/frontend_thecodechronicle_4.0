...
const HeadlineItem = ({ headline }) => {
  ...
  return (
    <Card classNames={'rounded-2xl w-full'}>
      {/* <div className={'h-[60vh] md:h-[50vh] lg:h-[40vh] w-full rounded-2xl flex flex-col justify-end gap-5 bg-cover bg-no-repeat bg-center p-5 lg:p-3'} style={{ backgroundImage: `url(${headline.primaryMedia.url ? headline.primaryMedia.url : PostImage})` }}> */}
      <div className={'h-[60vh] md:h-[50vh] lg:h-[40vh] w-full rounded-2xl flex flex-col justify-end gap-5 bg-cover bg-no-repeat bg-center p-5 lg:p-3'} style={{ backgroundImage: `url(${PostImage})` }}>
